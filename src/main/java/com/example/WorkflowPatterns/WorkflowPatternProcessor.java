...
import static com.example.WorkflowPatterns.BpmnModelParser.getRoleForNode;
...
public class WorkflowPatternProcessor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String, List<String>> graph = parser.parseBpmnFile(bpmnFile);
        Map<String, String> nodeTypes = parser.getNodeTypes(bpmnFile);
        Map<String, String> conditions = parser.getConditionsForFlows(bpmnFile);
        Map<String, String> nodeNames = parser.getNodeNames(bpmnFile);
        Collection<Lane> lanes = parser.getLanes(bpmnFile); // Collection der Lanes (Rollen) aus der BPMN-Datei
